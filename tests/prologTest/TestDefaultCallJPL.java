...
/**
 * This class is used as a Weka to check the jpl installation
 *
 */
public class TestDefaultCallJPL {
    ...
    static void test_0() {
        System.out.print("Weka 0...");
        //loading the file
        String t0 = "consult('./ressources/prolog/Weka/Weka.pl')";
